  ...
  const restaurantCategories = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'Daily selection of fresh oysters with classic accompaniments',
          price: 28,
          category: 'appetizers',
          type: 'restaurant' as const,
        },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'Atlantic halibut with lemon butter sauce and seasonal vegetables',
          price: 42,
          category: 'mains',
          type: 'restaurant' as const,
        },
      ...
      <section className="relative py-20 bg-gradient-to-br from-amber-900 via-orange-900 to-red-900 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
            <defs>
              <pattern id="dining-pattern" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white space-y-8">
              <div className="inline-flex items-center space-x-3 bg-amber-500/20 backdrop-blur-sm rounded-full px-6 py-3 border border-amber-400/30">
              ...
              <p className="text-xl text-gray-200 leading-relaxed">
                Experience culinary artistry at Patricia Hotel. Our world-class chefs create exceptional dishes 
                using the finest ingredients, paired with an extensive wine collection and premium spirits.
              </p>
            ...
            <div className="relative">
              <div className="aspect-square bg-gradient-to-br from-amber-600 via-orange-600 to-red-600 rounded-3xl p-8 transform rotate-2 hover:rotate-6 transition-all duration-500 relative overflow-hidden">
                <svg className="w-full h-full" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  {/* Chef Station */}
                  <rect x="160" y="320" width="80" height="60" fill="url(#kitchenGradient)" rx="8" />
                  <circle cx="200" cy="310" r="8" fill="#FDE68A" />
                  
                  {/* Wine Display */}
                  <rect x="50" y="80" width="20" height="40" fill="#7C2D12" rx="2" />
                  <rect x="75" y="70" width="20" height="50" fill="#7C2D12" rx="2" />
                  <rect x="100" y="85" width="20" height="35" fill="#7C2D12" rx="2" />
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-black/60 backdrop-blur-sm rounded-lg p-3 text-center text-white border border-white/20">
                  ...
                  <div className="text-xs opacity-75">Breakfast • Lunch • Dinner</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-16">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              From fine dining to premium cocktails, Patricia Hotel offers exceptional culinary experiences
            </p>
          </div>

          <DiningTabSystem
            restaurantContent={<RestaurantMenu categories={restaurantCategories} className="mt-6" />}
        ...
        <div className="bg-gradient-to-r from-amber-600 to-orange-600 rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto opacity-90">
            Reserve your table today and indulge in world-class cuisine and premium beverages
          </p>
