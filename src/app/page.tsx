  ...
  return (
    <main className="min-h-screen">
      ...
      <motion.section
        ...
        viewport={{ once: true }}
        className="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-primary-900 via-purple-900 to-pink-900 relative overflow-hidden"
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div
              ...
              viewport={{ once: true }}
              className="inline-flex items-center space-x-3 bg-gradient-to-r from-red-500/20 to-pink-500/20 backdrop-blur-sm rounded-full px-6 py-3 mb-6 border border-red-400/30"
            >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
              className="text-lg sm:text-xl md:text-2xl text-gray-200 max-w-4xl mx-auto leading-relaxed mb-8"
            >
              Benin City's premier nightclub destination - where top Nigerian
              DJs, Afrobeats rhythms, premium bottle service, and VIP
              experiences create legendary nights that celebrate our vibrant
              culture.
            </motion.p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm mb-3">
                      Top Naija DJs spinning the hottest Afrobeats and Amapiano
                      every weekend
                    </p>
                    <div className="flex flex-wrap gap-2">
                      <span className="px-3 py-1 bg-yellow-400/20 text-yellow-200 text-xs rounded-full border border-yellow-400/30">
                        Afrobeats
                      </span>
                      <span className="px-3 py-1 bg-pink-400/20 text-pink-200 text-xs rounded-full border border-pink-400/30">
                        Amapiano
                      </span>
                      <span className="px-3 py-1 bg-purple-400/20 text-purple-200 text-xs rounded-full border border-purple-400/30">
                        Afro-Fusion
                      </span>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm mb-3">
                      Premium bottle service with dedicated staff and prime
                      locations
                    </p>
                    <div className="flex flex-wrap gap-2">
                      <span className="px-3 py-1 bg-pink-400/20 text-pink-200 text-xs rounded-full border border-pink-400/30">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm mb-3">
                      State-of-the-art sound system, LED walls, and immersive
                      lighting
                    </p>
                    <div className="flex flex-wrap gap-2">
                      <span className="px-3 py-1 bg-blue-400/20 text-blue-200 text-xs rounded-full border border-blue-400/30">
                        L-Acoustics
                      </span>
                      <span className="px-3 py-1 bg-green-400/20 text-green-200 text-xs rounded-full border border-green-400/30">
                        LED Walls
                      </span>
                      <span className="px-3 py-1 bg-red-400/20 text-red-200 text-xs rounded-full border border-red-400/30">
                        Laser Shows
                      </span>
                    </div>
                  </div>
            ...
            >
              ...
              <motion.div
                ...
                className="aspect-square bg-gradient-to-br from-purple-600 via-pink-600 to-yellow-500 rounded-3xl p-8 transform rotate-2 transition-all duration-500 relative overflow-hidden group"
              >
                {/* Disco Ball Effect */}
                ...
                <div className="h-full relative z-10">
                  ...
                  >
                    ...
                    <g opacity="0.6">
                      <path
                        d="M100 108 L90 350 L110 350 Z"
                        fill="url(#lightBeam1)"
                      >
                        <animateTransform
                          attributeName="transform"
                          type="rotate"
                          values="0 100 108;10 100 108;0 100 108"
                          dur="3s"
                          repeatCount="indefinite"
                        />
                      </path>
                      <path
                        d="M200 88 L190 350 L210 350 Z"
                        fill="url(#lightBeam2)"
                      >
                        <animateTransform
                          attributeName="transform"
                          type="rotate"
                          values="0 200 88;-15 200 88;0 200 88"
                          dur="2.5s"
                          repeatCount="indefinite"
                        />
                      </path>
                      <path
                        d="M300 108 L290 350 L310 350 Z"
                        fill="url(#lightBeam3)"
                      >
                        <animateTransform
                          attributeName="transform"
                          type="rotate"
                          values="0 300 108;15 300 108;0 300 108"
                          dur="2s"
                          repeatCount="indefinite"
                        />
                      </path>
              ...
              <motion.div
                ...
                className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full animate-bounce flex items-center justify-center"
              >
                <svg
              ...
              <motion.div
                ...
                className="absolute -bottom-4 -right-4 w-10 h-10 bg-gradient-to-br from-pink-400 to-red-500 rounded-full animate-bounce flex items-center justify-center"
              >
                <svg
              ...
              <motion.div
                ...
                className="absolute top-1/2 -right-8 w-8 h-8 bg-gradient-to-br from-blue-400 to-purple-500 rounded-full animate-bounce flex items-center justify-center"
              >
                <svg
          ...
          >
            <motion.h3
              ...
              transition={{ duration: 0.6, delay: 0.8 }}
              viewport={{ once: true }}
              className="text-center text-white font-serif text-2xl sm:text-3xl font-bold mb-8"
            >
              This Week's Lineup
            </motion.h3>
            <motion.div
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              transition={{ duration: 0.8, staggerChildren: 0.1, delay: 1 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-gradient-to-br from-yellow-400/20 to-orange-500/20 rounded-xl p-4 text-center border-2 border-yellow-400/50"
              >
